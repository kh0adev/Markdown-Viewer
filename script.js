document.addEventListener("DOMContentLoaded", function () {
  ...
  const sampleMarkdown = templateText || '# Chào mừng đến Markdown\n\nStart typing your markdown here...';
  ...
  function createTabActionMenu(tab, options) {
    ...
    dropdown.innerHTML =
      '<button type="button" class="tab-menu-item" role="menuitem" data-action="rename"><i class="bi bi-pencil"></i> Đổi tên</button>' +
      '<button type="button" class="tab-menu-item" role="menuitem" data-action="duplicate"><i class="bi bi-files"></i> Nhân bản</button>' +
      '<button type="button" class="tab-menu-item tab-menu-item-danger" role="menuitem" data-action="delete"><i class="bi bi-trash"></i> Xoá</button>';
  ...
  function createAlertPreview(type, meta) {
    ...
    body.textContent = `${meta.label} - chi tiết tại đây.`;
  ...
  function openAlertModal() {
    ...
    function insertAlert() {
      ...
      const body = `${meta.label} - chi tiết tại đây.`;
      const block = `> [!${type}]\n> ${body}\n`;
      modal.style.display = 'none';
      cleanup();
...
<body>
  ...
  function showCopiedMessage() {
    ...
    copyMarkdownButton.innerHTML = '<i class="bi bi-check-lg"></i> Đã sao chép!';
